...
{
    internal class Ectoplasm_Bezoar_Poison : ModItem
    {
        public override void SetStaticDefaults()
        {
            //make it shimmer to the ectoplasm bezoar aura
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<Ectoplasm_Bezoar_Aura>();
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (player.itemAnimation > 0 && player.itemTime == 0 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                else
                {
                    ...
                    ffFunc.Talk(Language.GetTextValue("Mods.BossesPoisonAura.Chat.Used4"), new Color(50, 255, 130));
                }
            }
