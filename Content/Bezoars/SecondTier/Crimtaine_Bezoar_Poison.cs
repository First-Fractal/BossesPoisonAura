...
{
    internal class Crimtaine_Bezoar_Poison : ModItem
    {
        public override void SetStaticDefaults()
        {
            //make it shimmer to the crimtaine bezoar aura
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<Crimtaine_Bezoar_Aura>();
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (player.itemAnimation > 0 && player.itemTime == 0 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                {
                    //set the second upgrade to be poison and display it in the chat
                    ModContent.GetInstance<BPAModSystem>().upgrades[1] = upgradeType.poison;
